...
class _TextLineState extends State<TextLine> {
  ...
  TextStyle _getInlineTextStyle(leaf.Text textNode, DefaultStyles defaultStyles,
    ...
    final googleFont = textNode.style.attributes[AttributeExt.googleFont.key];
    final googleFontStyle = fontsMapping[googleFont?.value];
    if (googleFontStyle != null) {
      res = res.merge(googleFontStyle);
    }
